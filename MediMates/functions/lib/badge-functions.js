...
exports.dailyBadgeRefresh = exports.onMedMatchChanged = void 0;
...
async function computeBadgesForUser(uid) {
    ...
    for (const badgeCheck of BADGE_CHECKS) {
        if (existingTypes.has(badgeCheck.type))
            continue;
        try {
    ...
    if (newBadges.some((b) => b.type === 'experienced' || b.type === 'veteran') &&
...
// ──────────────────────────────────────────────
exports.onMedMatchChanged = (0, firestore_1.onDocumentWritten)('medMatches/{matchId}', async (event) => {
...
// ──────────────────────────────────────────────
exports.dailyBadgeRefresh = (0, scheduler_1.onSchedule)({
...
//# sourceMappingURL=badge-functions.js.map